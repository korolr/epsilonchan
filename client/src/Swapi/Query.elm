...
droid requiredArgs object_ =
    Object.selectionForCompositeField "droid" [ Argument.required "id" requiredArgs.id (Swapi.ScalarCodecs.codecs |> Swapi.Scalar.unwrapEncoder .codecId) ] object_ (identity >> Decode.nullable)
...
human requiredArgs object_ =
    Object.selectionForCompositeField "human" [ Argument.required "id" requiredArgs.id (Swapi.ScalarCodecs.codecs |> Swapi.Scalar.unwrapEncoder .codecId) ] object_ (identity >> Decode.nullable)


now : SelectionSet Swapi.ScalarCodecs.PosixTime RootQuery
now =
    Object.selectionForField "ScalarCodecs.PosixTime" "now" [] (Swapi.ScalarCodecs.codecs |> Swapi.Scalar.unwrapCodecs |> .codecPosixTime |> .decoder)
