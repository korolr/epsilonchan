...
-}
id : SelectionSet Swapi.ScalarCodecs.Id Swapi.Interface.Character
id =
    Object.selectionForField "ScalarCodecs.Id" "id" [] (Swapi.ScalarCodecs.codecs |> Swapi.Scalar.unwrapCodecs |> .codecId |> .decoder)
